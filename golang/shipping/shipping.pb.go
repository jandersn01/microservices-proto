...
func (x *CreateShippingRequest) GetItems() []*OrderItem {
	if x != nil {
		return x.Items
	}
	return nil
...
type CreateShippingResponse struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	OrderId              int64                  `protobuf:"varint,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	DeliveryDeadlineDays int32                  `protobuf:"varint,2,opt,name=delivery_deadline_days,json=deliveryDeadlineDays,proto3" json:"delivery_deadline_days,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *CreateShippingResponse) GetDeliveryDeadlineDays() int32 {
	if x != nil {
		return x.DeliveryDeadlineDays
	}
	return 0
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	".OrderItemR\x05items\"i\n" +
	"\x16CreateShippingResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x124\n" +
	"\x16delivery_deadline_days\x18\x02 \x01(\x05R\x14deliveryDeadlineDays2R\n" +
	"\bShipping\x12F\n" +
	"\x11CalculateDeadline\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponse\"\x00B7Z5github/jandersn01/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_shipping_proto_depIdxs = []int32{
	0, // 0: CreateShippingRequest.items:type_name -> OrderItem
	1, // 1: Shipping.CalculateDeadline:input_type -> CreateShippingRequest
	2, // 2: Shipping.CalculateDeadline:output_type -> CreateShippingResponse
