...
const (
	Shipping_CalculateDeadline_FullMethodName = "/Shipping/CalculateDeadline"
)
...
type ShippingClient interface {
	CalculateDeadline(ctx context.Context, in *CreateShippingRequest, opts ...grpc.CallOption) (*CreateShippingResponse, error)
}
...
func (c *shippingClient) CalculateDeadline(ctx context.Context, in *CreateShippingRequest, opts ...grpc.CallOption) (*CreateShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateShippingResponse)
	err := c.cc.Invoke(ctx, Shipping_CalculateDeadline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServer interface {
	CalculateDeadline(context.Context, *CreateShippingRequest) (*CreateShippingResponse, error)
...
func (UnimplementedShippingServer) CalculateDeadline(context.Context, *CreateShippingRequest) (*CreateShippingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CalculateDeadline not implemented")
}
...
func _Shipping_CalculateDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServer).CalculateDeadline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_CalculateDeadline_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServer).CalculateDeadline(ctx, req.(*CreateShippingRequest))
	}
...
var Shipping_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CalculateDeadline",
			Handler:    _Shipping_CalculateDeadline_Handler,
		},
	},
